...
For Android use [WayTodaySDK-Android](https://github.com/s4ysolutions/WayTodaySDK-Android) 4.4.0+, which wraps this SDK with WorkManager-based background uploads.
